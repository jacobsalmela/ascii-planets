...
\begin{itemize}
	\item Seating order: you will have \reach\ to the players sitting next to you after you build and staff at least one \starship. (exception: 2-player games, see \nameref{sec:playercount}, p.\pageref{sec:playercount}).
